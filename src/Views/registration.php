<div class="content">
    ...
    <form id="reg" name="registration">
        <div class="add">
            ...
            <input id="uname" name="uname" type="text" minlength="2" maxlength="50" required placeholder="Иван"/>
        </div>

        <div class="add">
            <label for="surname">Фамилия: </label><br />
            <input id="surname" name="surname" type="text" minlength="1" maxlength="50" required placeholder="Иванов">
        </div>

        <div class="add">
            <label for="phone">Телефон: </label><br />
            <input type="text" id="phone" name="phone" required placeholder="+79999999999">
        </div>
        ...
        <div class="add">
            ...
            <input id="bith" name="bith" type="date" placeholder="01.01.2001" required>
        </div>
